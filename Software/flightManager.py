...
class FlightManager:
    ...
    def __init__(self, flight_data_filename: str = None) -> None:
    ...
    async def fly(self, is_development: bool) -> None:
        ...
        if not is_development:
            try:
                ...
                print(f"Opened flight data file: {self.flight_data_filename} for logging")
    ...
    def calculate_acceleration(self, previous_velocity, current_velocity, delta_time):
        ...
        self.vertical_acceleration = self.kalman_filter_acceleration.update(raw_acceleration)
